...
namespace ShuppanButsu.Tests.Domain.Blog.PostTests
{
    ...
    public class BasicPostFixture : BaseTestFixtureWithHelper
    {
        ...
        [Fact]
        public void verify_creation_of_abstract_during_post_creation_if_noone_is_bringed_by_the_caller()
        {
            Post post = Post.CreatePost(this.AggregateRootFactory(), "äöüÄÖÜ", "<b>this is the body</b>", "", "");
            this.GetFirstDomainEvent<PostCreated>()
                .Excerpt.Should().Be.EqualTo("this is the body");
        }
    }
}
